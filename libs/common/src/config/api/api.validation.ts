...
export const apiValidationSchema: Required<SchemaMap<ApiEnv>> = {
    ...
    SWAGGER_API_URL: Joi.string()
        .uri()
        .optional(),
    SWAGGER_URI_PATH: Joi.string()
        .uri({ relativeOnly: true })
        .optional(),
    SWAGGER_REMOTE_SERVER_URLs: Joi.string()
        .uri()
        .optional(),

    SW_STATS_ENABLED: Joi.boolean().default(false),
    SW_STATS_URI_PATH: Joi.string()
        .uri({ relativeOnly: true })
        .optional(),
    ...
    SW_STATS_SESSION_MAX_AGE: Joi.number()
        .positive()
        .integer()
        .optional(),
    SW_STATS_TIMELINE_BUCKET_DURATION: Joi.number()
        ...
        .optional(),
    SW_STATS_APDEX_THRESHOLD: Joi.number()
        .integer()
        .valid(25, 50, 100)
        .optional(),
